...
/* harmony import */ var _pages_tabbar_index_index_nvue_mpType_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/tabbar/index/index.nvue?mpType=page */ 160);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_nvue_vue_type_template_id_52b89256_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.nvue?vue&type=template&id=52b89256&mpType=page */ 161);
...
function injectStyles (context) {
  ...
  if(!this.options.style){
      ...
      if(Vue.prototype.__merge_style){
                Vue.prototype.__merge_style(__webpack_require__(/*! ./index.nvue?vue&type=style&index=0&lang=css&mpType=page */ 172).default, this.options.style)
            }else{
                Object.assign(this.options.style,__webpack_require__(/*! ./index.nvue?vue&type=style&index=0&lang=css&mpType=page */ 172).default)
            }
    ...
    [
      _c(
        ...
        [
          _c(
            "navigator-bar",
            { ref: "topBar", attrs: { title: "微信", number: "10" } },
            [
          ...
          _c(
            "scroller",
            { staticClass: ["chat-lists"], attrs: { showScrollbar: "false" } },
            _vm._l(_vm.chats, function(item, i) {
              return _c("list-item", {
                key: i,
                attrs: {
                  data: item,
                ...
                on: { longpress: _vm.longpress, onCLick: _vm.onCLick }
              })
            }),
            1
          ),
          _c(
            "c-popup",
            { ref: "popup", attrs: { height: _vm.height, width: 240 } },
            [
              _c(
                "view",
                {
                ...
                _vm._l(_vm.menus, function(item, i) {
                  return _c(
                    ...
                    {
                      key: i,
                      staticClass: ["justify-center", "pl-3", "flex-1"],
                      attrs: { hoverClass: "bg-main" },
                      on: {
                        click: function($event) {
                          _vm.clickMenu(item)
                        }
